...
<main id="main-content" class="gcso-main gcso-wide-page gcso-employment-page" role="main">
    ...
    <div class="gcso-container gcso-content-area gcso-content-area--wide">
        ...
        <div class="gcso-service-page">
            ...
            <section class="gcso-employment-cta" aria-labelledby="employment-cta-heading">
                <div>
                    <h2 id="employment-cta-heading"><?php esc_html_e('Ready to Join the Team?', 'gcso'); ?></h2>
                    <p><?php esc_html_e('Download the employment application and submit the completed application and required documentation in person or by email.', 'gcso'); ?></p>
                </div>
                <a href="https://gordonsheriff.org/resources/employment-application-2/#docaccess-9b635b963d2496d080233835ca761bcc" class="gcso-btn gcso-btn--gold" target="_blank" rel="noopener noreferrer">
                    <?php esc_html_e('Get the Employment Application', 'gcso'); ?>
            ...
            <div class="gcso-info-cards">
                <div class="gcso-info-card gcso-info-card--full gcso-info-card--highlight">
                    ...
                    <div class="gcso-info-card__body">
                        <p><?php esc_html_e('Click the link below to access the Employment Application.', 'gcso'); ?></p>
                        <p>
                            <a href="https://gordonsheriff.org/resources/employment-application-2/#docaccess-9b635b963d2496d080233835ca761bcc" class="gcso-btn gcso-btn--outline-navy" target="_blank" rel="noopener noreferrer">
                                <?php esc_html_e('Employment Application', 'gcso'); ?>
                                <span aria-hidden="true">↗</span>
                            </a>
                        </p>
                        ...
                        <p>
                            <strong><?php esc_html_e('Online:', 'gcso'); ?></strong><br>
                            <a href="mailto:gcsoapplications@gordoncountyga.gov">gcsoapplications@gordoncountyga.gov</a>
                        </p>
                        <p>
