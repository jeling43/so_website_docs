    ...
    <div class="gcso-container gcso-content-area gcso-content-area--wide">
        ...
        <div class="gcso-service-page gcso-divisions-page">
            <section class="gcso-divisions-overview" aria-labelledby="office-overview-heading">
                ...
                <aside class="gcso-divisions-overview__stat" aria-label="Gordon County Sheriff’s Office">
                    <img
                        class="gcso-divisions-overview__badge"
                        src="<?php echo esc_url(GCSO_URI . '/assets/images/badge-Photoroom.png'); ?>"
                        alt="Gordon County Sheriff’s Office badge"
                        width="108"
                        height="108"
                        loading="lazy"
                    >
                    <span><?php esc_html_e('Gordon County Sheriff\'s Office', 'gcso'); ?></span>
                </aside>
            </section>
            ...
            <section aria-labelledby="bureaus-heading">
                ...
                <div class="gcso-bureau-grid">
                    ...
                    <article class="gcso-bureau-card">
                        ...
                        <div class="gcso-bureau-card__body">
                            <p><?php esc_html_e('The Judicial Bureau includes the Jail Division and Court Services Division.', 'gcso'); ?></p>
                            <h3><?php esc_html_e('Court Services Division', 'gcso'); ?></h3>
                            <p><?php esc_html_e('Receives and serves court process—including warrants, civil actions, and summonses—transports inmates, and provides physical security for the Superior Court and its judges.', 'gcso'); ?></p>
                            <h3><?php esc_html_e('Jail Division', 'gcso'); ?></h3>
                            <p><?php esc_html_e('Provides for the safe and secure operation of the county jail, safeguards inmate occupants, and maintains required incarceration records.', 'gcso'); ?></p>
                            <p class="gcso-bureau-card__action">
