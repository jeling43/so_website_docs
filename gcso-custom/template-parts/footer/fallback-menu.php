...
function gcso_footer_fallback_menu() {
    ...
    echo '<li><a href="' . esc_url(home_url('/submit-a-tip/')) . '">' . esc_html__('Submit a Tip', 'gcso') . '</a></li>';
    echo '<li><a href="' . esc_url(home_url('/resources/request-a-report/')) . '">' . esc_html__('Request a Report', 'gcso') . '</a></li>';
