        ...
        <article class="gcso-page-content gcso-legal-page">
            <div class="gcso-page-content__body gcso-content">
                ...
                <ul>
                    ...
                    <li><?php esc_html_e('Technical information, such as your IP address, browser type, operating system, and pages visited, collected automatically through server logs and our website host, CivicPlus.', 'gcso'); ?></li>
                ...
                <p><?php esc_html_e('Some pages on this Site may include links to third-party websites or services. We are not responsible for the privacy practices of those external sites. We encourage you to review their privacy policies before providing personal information.', 'gcso'); ?></p>
                ...
                <p><?php esc_html_e('You may:', 'gcso'); ?></p>
                <ul>
                    <li><?php esc_html_e('Disable cookies through your browser settings.', 'gcso'); ?></li>
                    <li><?php esc_html_e('Choose not to provide personal information when requested, although this may limit access to certain services.', 'gcso'); ?></li>
                </ul>

                <h2><?php esc_html_e('8. Changes to This Privacy Policy', 'gcso'); ?></h2>
                <p><?php esc_html_e('We may update this Privacy Policy periodically to reflect changes in technology, law, or our practices. Updates will be posted on this page with a revised Last updated date.', 'gcso'); ?></p>
            </div>
        </article>
    </div>
</main>
