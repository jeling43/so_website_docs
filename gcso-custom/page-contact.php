            ...
            <section class="gcso-contact-cards" aria-labelledby="contact-heading">
                ...
                <div class="gcso-contact-cards__grid">
                    <div class="gcso-contact-card">
                        ...
                        <p><a href="tel:<?php echo esc_attr(gcso_get_option('gcso_phone', '706-629-1245')); ?>"><?php echo esc_html(gcso_get_option('gcso_phone', '706-629-1245')); ?></a></p>
                    </div>
                    ...
                    <div class="gcso-contact-card">
                        ...
                        <p><?php echo esc_html(gcso_get_option('gcso_address', '2700 Highway 41 North, Calhoun, Georgia 30701')); ?></p>
                    ...
                    <div class="gcso-contact-card">
                        ...
                        <p class="gcso-contact-card__note"><?php esc_html_e('Call the Non-Emergency line for assistance.', 'gcso'); ?></p>
                    </div>
                    ...
                    <div class="gcso-contact-card">
                        ...
                        <p><a href="tel:+17068795515">706-879-5515</a></p>
